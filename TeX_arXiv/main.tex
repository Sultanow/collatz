...
\begin{table}[H]
	...
	\begin{tabular}{|L|L|L|L|}
		\hline
		\thead{\boldsymbol{k}} &
		\thead{\textbf{Engel expansion formula}} &
		\thead{\textbf{example sequence}} &
		\thead{\textbf{resulting}~\boldsymbol{v_{n+1}}}\\
		\hline
		1 & v_{n+1}=\frac{v_1-1+2^n}{2^n}
		& 17, 9, 5, 3
		& \frac{4}{3}
		\\ \hline
		3 & 1+\frac{1}{5v_1} + \frac{5v_1+1}{15v_1v_2}\left(1-\left(\frac{2}{5}\right)^{n-1}\right) & v_1=1,v_2=3,n=2
		& \frac{32}{25}
		\\ \hline
		5 & 1+\frac{1}{7v_1} + \frac{7v_1+1}{35v_1v_2}\left(1-\left(\frac{2}{7}\right)^{n-1}\right) & v_1=1,n=1
		& \frac{8}{7}
		\\ \hline
		...
		\\ \hline
	\end{tabular}
	\caption{Exemplary Engel expansions for $b=2$ and $k=1,3,5,7$}
