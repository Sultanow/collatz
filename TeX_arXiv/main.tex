...
\prod_{i=1}^{n}\left(1+\frac{1}{kv_i}\right)&=\frac{1}{(k-2)v_1}\left(1+\frac{2^{\alpha_1}}{k}\left(1-\left(\frac{2}{k}\right)^{n-1}\right)-\frac{2}{k}\right)+1\\
\label{eq:prod_engel_more_divisions_v2}
&=\frac{1}{(k-2)v_1}\left(1+\frac{kv_1+1}{kv_2}\left(1-\left(\frac{2}{k}\right)^{n-1}\right)-\frac{2}{k}\right)+1
\end{flalign}
...
&=\frac{1}{(3-2)\cdot 661}\left(1+\frac{3\cdot 661+1}{3\cdot 31}\left(1-\left(\frac{2}{3}\right)^{4-1}\right)-\frac{2}{3}\right)+1\\
&=1.023215853
\end{flalign*}
\end{example}
...
\begin{table}[H]
	...
	\begin{tabular}{|L|L|L|L|}
		...
		& \frac{4}{3}
		\\ \hline
		5 & 1+\frac{3}{15v_1} + \frac{5v_1+1}{15v_1v_2}\left(1-\left(\frac{2}{5}\right)^{n-1}\right) & v_1=1,v_2=3,n=2
		& \frac{32}{25}
		\\ \hline
		7 & 1+\frac{5}{35v_1} + \frac{7v_1+1}{35v_1v_2}\left(1-\left(\frac{2}{7}\right)^{n-1}\right) & v_1=1,n=1
		& \frac{40}{35}
		\\ \hline
	\end{tabular}
