/******************************************************************************/
/*									      */
/* CHECK PTH POWER W.R.T. RELATIONSHIP FOR P=3 (a+b*rho^2)		      */
/* 02/15/21 (dkc)							      */
/*									      */
...
int cutoff=100;	// normally set to 30
int start=540;   // normally set to 0
int stop=584;  // normally set to 584
unsigned int nodd=0;  // if set, don't compute odd numbered input
...
int main () {
int f,g,h,i,j,k;
int A[2],T[2],U[2],q,temp;
FILE *Outfp;
Outfp = fopen("ppwrta.dat","w");
if ((nodd!=0)&&(diff!=0)) {
