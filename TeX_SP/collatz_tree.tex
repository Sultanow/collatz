...
\par\noindent
Sultanow, Koch and Cox \cite[p.~10]{Ref_Sultanow_Koch_Cox_2020} showed that odd numbers of Collatz sequences can be calculated with the following recursive equation:
\begin{equation}
