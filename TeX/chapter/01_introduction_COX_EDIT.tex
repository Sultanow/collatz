...
\par\medskip\noindent
\textit{\textbf{A deeper look at the number of divisions by two}} is taken by Paul S. Bruckman \cite{Ref_Bruckman_2008}, who has attempted to provide an elementary proof by contradiction. He repeatedly applies the Collatz function using a starting value $n_0$ and defines:
\[
