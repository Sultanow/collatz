...
The variable $\beta_{n+1}$ can be calculated by the following equation:
...
\begin{example}
	...
	\[
	\beta_{n+1}=1+\frac{1}{3v_{1+1}}=1+\frac{1}{3\cdot5}=1.0\overline{6}
	\]
\end{example}
...
\begin{example}
For example for $v_1=13$ and $n=1$:
\[
\beta_{n+1}=1+\frac{\prod_{i=1}^{1}2^{\alpha_i}}{3^{1+1}v_1\prod_{i=1}^{1}\beta_i}
\]
\[
1.0\overline{6}=1+\frac{2^3}{3^2\cdot13\cdot1.0256}=1+\frac{1}{3\cdot5}
\]
\end{example}
...
&=\prod_{i=1}^{n}\beta_i+\frac{\prod_{i=1}^{n}2^{\alpha_i}}{3^{n+1}v_1}\\
...
In the last step we put the product of the powers of two to the left side and obtain equation~\ref{eq:prod_power_of_two}:
\begin{equation}
...
\begin{flalign*}
v_{n+1}&=3^{n}v_1\prod_{i=1}^{n}\beta_i\prod_{i=1}^{n}2^{-\alpha_i}\\
v_{n+2}&=3^{n+1}v_1\prod_{i=1}^{n+1}\beta_i\left(\prod_{i=1}^{n}2^{-\alpha_i}\right)2^{-\alpha_{n+1}}=\frac{3^{n+1}v_1\prod_{i=1}^{n+1}\beta_i}{2^{\alpha_{n+1}}\prod_{i=1}^{n}2^{\alpha_i}}\\
&=\frac{3^{n+1}\cdot v_1\cdot2}{3^{n+1}v_1\left(2-\prod_{i=1}^{n}\beta_i\right)\cdot2^{n+1}}=\frac{2}{\left(2-\prod_{i=1}^{n}\beta_i\right)\cdot2^{n+1}}
\end{flalign*}
